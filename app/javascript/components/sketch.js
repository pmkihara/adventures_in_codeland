...
const initP5 = () => {
  const sketch = (s) => {
    s.setup = () => {
      ...
      character.addClass('pixel-art character-sprite character-down');
      character.style("background-image: url(/assets/cat-sprite-3e3fbf4062b56d456f56c73f3b7d58bcef2b90f8c2d5a6bea565fa64173e1592.png)");
    }
